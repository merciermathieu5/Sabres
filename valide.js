/* Harnais de validation — Sabres de Buffalo (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'BUFFALO',
  taille: 23,
  echantillon: {nom: 'Mika Zibanejad', salaire: 8450000, ct: 2, ov: 83},
  masseSousContrat: 67650000,
  nbSousContrat: 11,
  dateSecours: '8 juillet 2026',
  nbEchus: 11,
  nbBackups: 1,
  masseTotale: 103825000
};
...
(async () => {
  ...
  W.localStorage.removeItem('buf_resignatures_v1');
  W.localStorage.removeItem('buf_transac_v1');
